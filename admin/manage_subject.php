...
<div class="container-fluid">
	<form action="" id="manage-subject">
		...
		<div class="form-group">
  <label for="schedule_in" class="control-label">Start Time</label>
  <input type="time" class="form-control form-control-sm" name="schedule_in" id="schedule_in" value="<?php echo isset($schedule_in) ? $schedule_in : '' ?>" required step="any" inputmode="numeric">
</div>
<div class="form-group">
  <label for="schedule_out" class="control-label">End Time</label>
  <input type="time" class="form-control form-control-sm" name="schedule_out" id="schedule_out" value="<?php echo isset($schedule_out) ? $schedule_out : '' ?>" required step="any" inputmode="numeric">
</div>
