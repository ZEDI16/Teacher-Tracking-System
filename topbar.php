...
<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark ">
    ...
    <?php endif; ?>
      <li>
        <a class="nav-link text-white"  href="./" role="button"> <large><b class="loginzxzx"><?php echo $_SESSION['system']['name'] ?></b></large></a>
      </li>
    </ul>
            ...
            <a class="nav-link"  data-toggle="dropdown" aria-expanded="true" href="javascript:void(0)">
              <span>
                <div class="d-felx badge-pill">
                  ...
                  <span><b class="loginzxzx"><?php echo ucwords($_SESSION['login_firstname']) ?></b></span>
